  ...
  return (
    <header className="shadow sticky z-50 top-0">
      <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5">
        <div id="mobile-header" className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          <Link to="/" className="flex items-center">
            <img src={myLogo} className="mr-3 h-12" alt="Logo" />
          </Link>
          <div id="signin-signup" className="flex items-center lg:order-2">
            <Link
              to="/signin"
